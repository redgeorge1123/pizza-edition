...
// Tooltip functionality for game thumbnails
document.addEventListener('DOMContentLoaded', function() {
  // Find all game thumbnails
  const thumbnails = document.querySelectorAll('.list-thumbnail');
  
  // For each thumbnail, create a tooltip with the alt text
